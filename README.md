# The Learning Gap:Measuring The Digital Poverty of US During The COVID-19 Pandemic Based On Online Education Data
...
```
python3 week2pageLoad.py
```
Output:
![week2pageLoad.png](https://github.com/anitalu724/110-1_Data-Science-Final-Project/blob/main/output/png/week2pageLoad.png?raw=true)

```
python3 time2engagement_lunch.py
```
Output:
![week2pageLoad.png](https://github.com/anitalu724/110-1_Data-Science-Final-Project/blob/main/output/png/time2engagement_lunch.png?raw=true)

```
python3 time2engagement_black.py
```
Output:
![week2pageLoad.png](https://github.com/anitalu724/110-1_Data-Science-Final-Project/blob/main/output/png/time2engagement_black.png?raw=true)
