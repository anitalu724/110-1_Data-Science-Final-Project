...
def time2engagement(target, output_name, annotation):
    ...
    text = [
        "<b style='color:%s; font-family:Tahoma; font-size:12px'>0-20%%</b>" % (palette_red),
        "<b style='color:%s; font-family:Tahoma; font-size:12px'>Hispanic/black students</b>" % (palette_red),
        # "<b style='color:%s; font-family:Tahoma; font-size:12px'>students</b>" % (palette_red),
        "116 districts" 
    ]

    annotation_helper(fig, text, datetime.date(2020, 11, 2), 80, [25, 30], width=200)
    ...
    #     "<span style='font-size:13px; font-family:Helvetica'> in <b style='color:%s'>white-dominated school districts</b>. </span>" % (palette_red)
    ...
    # fig.show()
    # fig.write_image('output/png/time2engagement_black.png',scale=1, width=800, height=550)
    # fig.write_image('output/pdf/time2engagement_black.pdf',scale=1, width=800, height=550)

    # fig.write_image('output/png/time2engagement_lunch.png',scale=1, width=800, height=550)
    # fig.write_image('output/pdf/time2engagement_lunch.pdf',scale=1, width=800, height=550)
